...
void Global_Fit_3H_SOG_Swif2(Int_t nout = 1)
{
  ...
  if(usedifmin == 1)
    {//File *fp = new File;
      ...
      fp = fopen("/home/skbarcus/New_SOG/SOG/New_Fits/H3_Bootstrapped_Data9.txt","r");
  ...
  std::ofstream output (Form("/home/skbarcus/New_SOG/SOG/New_Fits/Fit_Pars_3H_Bootstrap9_%d_5-20-2022.txt",nout), std::ofstream::out);
