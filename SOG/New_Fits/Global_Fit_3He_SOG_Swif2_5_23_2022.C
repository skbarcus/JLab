...
fp = fopen("/home/skbarcus/New_SOG/SOG/New_Fits/He3_Bootstrapped_Data9.txt","r");
  ...
  std::ofstream output (Form("/home/skbarcus/New_SOG/SOG/New_Fits/Fit_Pars_3He_Bootstrap9_%d_5-20-2022.txt",nout), std::ofstream::out);
