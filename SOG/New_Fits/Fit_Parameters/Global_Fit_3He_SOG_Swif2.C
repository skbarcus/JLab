...
void Global_Fit_3He_SOG_Swif2(Int_t nout = 1)
{
...
fp = fopen("/home/skbarcus/New_SOG/SOG/New_Fits/He3_Bootstrapped_Data28.txt","r");
  ...
  std::ofstream output (Form("/home/skbarcus/New_SOG/SOG/New_Fits/Fit_Pars_3He_Bootstrap28_%d_6-29-2022.txt",nout), std::ofstream::out);
  ...
  for(Int_t q=0;q<loops;q++)
      ...
      if(showplots == 1)
	{
	  ...
	  c1->SaveAs("/home/skbarcus/New_SOG/SOG/New_Fits/Output/Chi2_vs_Angle.png");
	  c1->SaveAs("/home/skbarcus/New_SOG/SOG/New_Fits/Output/Chi2_vs_Angle.C");
	  ...
	  //Save the canvas as a .png file and a .C file.
	  cQ2->SaveAs("/home/skbarcus/New_SOG/SOG/New_Fits/Output/Chi2_vs_Q2.png");
	  cQ2->SaveAs("/home/skbarcus/New_SOG/SOG/New_Fits/Output/Chi2_vs_Q2.C");
	  ...
	  //Save the canvas as a .png file and a .C file.
	  cxsfit_theta->SaveAs("/home/skbarcus/New_SOG/SOG/New_Fits/Output/XSExp_Over_XSFit_vs_Theta.png");
	  cxsfit_theta->SaveAs("/home/skbarcus/New_SOG/SOG/New_Fits/Output/XSExp_Over_XSFit_vs_Theta.C");
	  ...
	  //Save the canvas as a .png file and a .C file.
	  cxsfit_q->SaveAs("/home/skbarcus/New_SOG/SOG/New_Fits/Output/XSExp_Over_XSFit_vs_Q.png");
	  cxsfit_q->SaveAs("/home/skbarcus/New_SOG/SOG/New_Fits/Output/XSExp_Over_XSFit_vs_Q.C");
	  ...
	  //Save the canvas as a .png file and a .C file.
	  cresidual->SaveAs("/home/skbarcus/New_SOG/SOG/New_Fits/Output/Residual_vs_Q.png");
	  cresidual->SaveAs("/home/skbarcus/New_SOG/SOG/New_Fits/Output/Residual_vs_Q.C");
  ...
  */
  if(showplots == 1)
    {
      ...
      //Save the canvas as a .png file and a .C file.
      c2->SaveAs("/home/skbarcus/New_SOG/SOG/New_Fits/Output/ChFF.png");
      c2->SaveAs("/home/skbarcus/New_SOG/SOG/New_Fits/Output/ChFF.C");
      ...
      for(Int_t i=1;i<2;i++)
	{
      ...
      */
      ...
      //Save the canvas as a .png file and a .C file.
      c4->SaveAs("/home/skbarcus/New_SOG/SOG/New_Fits/Output/MFF.png");
      c4->SaveAs("/home/skbarcus/New_SOG/SOG/New_Fits/Output/MFF.C");
      ...
      if(bootstrap == 1)
	{
      ...
      //Save the canvas as a .png file and a .C file.
      c5->SaveAs("/home/skbarcus/New_SOG/SOG/New_Fits/Output/FF_Comparison.png");
      c5->SaveAs("/home/skbarcus/New_SOG/SOG/New_Fits/Output/FF_Comparison.C");
    }//End showplots.
  ...
  //Save the canvas as a .png file and a .C file.
  crho->SaveAs("/home/skbarcus/New_SOG/SOG/New_Fits/Output/Charge_Density.png");
  crho->SaveAs("/home/skbarcus/New_SOG/SOG/New_Fits/Output/Charge_Density.C");
  ...
  if(useFB == 1)
	...
	{ 
	  ...
	  //Save the canvas as a .png file and a .C file.
	  cresidual_FB->SaveAs("/home/skbarcus/New_SOG/SOG/New_Fits/Output/FB_Residual_vs_Q.png");
	  cresidual_FB->SaveAs("/home/skbarcus/New_SOG/SOG/New_Fits/Output/FB_Residual_vs_Q.C");
	  ...
	  //Save the canvas as a .png file and a .C file.
	  cFB_FC->SaveAs("/home/skbarcus/New_SOG/SOG/New_Fits/Output/FB_FC.png");
	  cFB_FC->SaveAs("/home/skbarcus/New_SOG/SOG/New_Fits/Output/FB_FC.C");
	  ...
	  if(useFB_FM == 1)
	    {
	      ...
	      fFB_FM->Draw("L");
	      //Save the canvas as a .png file and a .C file.
	      cFB_FM->SaveAs("/home/skbarcus/New_SOG/SOG/New_Fits/Output/FB_FM.png");
	      cFB_FM->SaveAs("/home/skbarcus/New_SOG/SOG/New_Fits/Output/FB_FM.C");
	    }
	  ...
	  fFB_rho->Draw("L");
	  //Save the canvas as a .png file and a .C file.
	  cFB_rho->SaveAs("/home/skbarcus/New_SOG/SOG/New_Fits/Output/FB_rho.png");
	  cFB_rho->SaveAs("/home/skbarcus/New_SOG/SOG/New_Fits/Output/FB_rho.C");
