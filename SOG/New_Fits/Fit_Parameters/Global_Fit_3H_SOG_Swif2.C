...
void Global_Fit_3H_SOG_Swif2(Int_t nout = 1)
{
  ...
  if(usedifmin == 1)
    {//File *fp = new File;
      ...
      fp = fopen("/home/skbarcus/New_SOG/SOG/New_Fits/H3_Bootstrapped_Data28.txt","r");
  ...
  std::ofstream output (Form("/home/skbarcus/New_SOG/SOG/New_Fits/Fit_Pars_3H_Bootstrap28_%d_6-29-2022.txt",nout), std::ofstream::out);
  ...
  for(Int_t q=0;q<loops;q++)
      ...
      if(showplots == 1)
	{
	  ...
	  */
	  ...
	  c1->SaveAs("/home/skbarcus/New_SOG/SOG/New_Fits/Output/Chi2_vs_Angle_3H.png");
	  c1->SaveAs("/home/skbarcus/New_SOG/SOG/New_Fits/Output/Chi2_vs_Angle_3H.C");
	  ...
	  */
	  ...
	  //Save the canvas as a .png file and a .C file.
	  cQ2->SaveAs("/home/skbarcus/New_SOG/SOG/New_Fits/Output/Chi2_vs_Q2_3H.png");
	  cQ2->SaveAs("/home/skbarcus/New_SOG/SOG/New_Fits/Output/Chi2_vs_Q2_3H.C");
	  ...
	  */
	  ...
	  //Save the canvas as a .png file and a .C file.
	  cxsfit_theta->SaveAs("/home/skbarcus/New_SOG/SOG/New_Fits/Output/XSExp_Over_XSFit_vs_Theta_3H.png");
	  cxsfit_theta->SaveAs("/home/skbarcus/New_SOG/SOG/New_Fits/Output/XSExp_Over_XSFit_vs_Theta_3H.C");
	  ...
	  */
	  ...
	  //Save the canvas as a .png file and a .C file.
	  cxsfit_q->SaveAs("/home/skbarcus/New_SOG/SOG/New_Fits/Output/XSExp_Over_XSFit_vs_Q_3H.png");
	  cxsfit_q->SaveAs("/home/skbarcus/New_SOG/SOG/New_Fits/Output/XSExp_Over_XSFit_vs_Q_3H.C");
	  ...
	  */
	  ...
	  //Save the canvas as a .png file and a .C file.
	  cresidual->SaveAs("/home/skbarcus/New_SOG/SOG/New_Fits/Output/Residual_vs_Q_3H.png");
	  cresidual->SaveAs("/home/skbarcus/New_SOG/SOG/New_Fits/Output/Residual_vs_Q_3H.C");
  ...
  if(showplots == 1)
    {
      ...
      //Save the canvas as a .png file and a .C file.
      c2->SaveAs("/home/skbarcus/New_SOG/SOG/New_Fits/Output/ChFF_3H.png");
      c2->SaveAs("/home/skbarcus/New_SOG/SOG/New_Fits/Output/ChFF_3H.C");
      ...
      //Save the canvas as a .png file and a .C file.
      c4->SaveAs("/home/skbarcus/New_SOG/SOG/New_Fits/Output/MFF_3H.png");
      c4->SaveAs("/home/skbarcus/New_SOG/SOG/New_Fits/Output/MFF_3H.C");
      ...
      if(bootstrap == 1)
	{
      ...
      //Save the canvas as a .png file and a .C file.
      c5->SaveAs("/home/skbarcus/New_SOG/SOG/New_Fits/Output/FF_Comparison_3H.png");
      c5->SaveAs("/home/skbarcus/New_SOG/SOG/New_Fits/Output/FF_Comparison_3H.C");
    }//End showplots.
  ...
  //Save the canvas as a .png file and a .C file.
  crho->SaveAs("/home/skbarcus/New_SOG/SOG/New_Fits/Output/Charge_Density_3H.png");
  crho->SaveAs("/home/skbarcus/New_SOG/SOG/New_Fits/Output/Charge_Density_3H.C");
  ...
  if(useFB == 1)
	...
	{ 
	  ...
	  */
	  ...
	  //Save the canvas as a .png file and a .C file.
	  cresidual_FB->SaveAs("/home/skbarcus/New_SOG/SOG/New_Fits/Output/FB_Residual_vs_Q_3H.png");
	  cresidual_FB->SaveAs("/home/skbarcus/New_SOG/SOG/New_Fits/Output/FB_Residual_vs_Q_3H.C");
	  ...
	  //Save the canvas as a .png file and a .C file.
	  cFB_FC->SaveAs("/home/skbarcus/New_SOG/SOG/New_Fits/Output/FB_FC_3H.png");
	  cFB_FC->SaveAs("/home/skbarcus/New_SOG/SOG/New_Fits/Output/FB_FC_3H.C");
	  ...
	  if(useFB_FM == 1)
	    {
	      ...
	      fFB_FM->Draw("L");
	      //Save the canvas as a .png file and a .C file.
	      cFB_FM->SaveAs("/home/skbarcus/New_SOG/SOG/New_Fits/Output/FB_FM_3H.png");
	      cFB_FM->SaveAs("/home/skbarcus/New_SOG/SOG/New_Fits/Output/FB_FM_3H.C");
	    }
	  ...
	  fFB_rho->Draw("L");
	  //Save the canvas as a .png file and a .C file.
	  cFB_rho->SaveAs("/home/skbarcus/New_SOG/SOG/New_Fits/Output/FB_rho_3H.png");
	  cFB_rho->SaveAs("/home/skbarcus/New_SOG/SOG/New_Fits/Output/FB_rho_3H.C");
