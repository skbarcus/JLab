...
adc = np.load("./Data/adc_integrals_run820.npy")
hits = np.load("./Data/hits_run820.npy")
...
results = model.fit(adc_train, hits_train, epochs=30, batch_size=64, validation_split=0.3333)
