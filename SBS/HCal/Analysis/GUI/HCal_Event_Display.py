...
infile = "/home/skbarcus/JLab/SBS/HCal/Analysis/Cosmics/rootfiles/fadc_f1tdc_1727.root"
...
class DVCS_Pulser_Control_GUI:
    def __init__(self, primary):
        ...
        for pmt in range(0,npmt):
            ...
            row = int(pmt/ncol)
            col = pmt%ncol
            canvas_arr[pmt].get_tk_widget().grid(row=row,column=col)#If here longer start for GUI initially. If in display plot function makes first plotting slower.
            #canvas_arr[pmt].draw()
            """
            canvas_arr[pmt].draw()
