...
def initUI(self):
    ...
    for i in range(0,nrows):
        ...
        #buttons = []
    for i in range(0,channels):
        buttons.append(Button(self, text=pmt_mods[i], command=self.connections))
        #buttons[i].bind("<1>", connections)
        #button = Button(self, text=pmt_mods[i], command=self.connections)
